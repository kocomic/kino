...
var sourceAdapterHandlers = map[string]bool{"rom_directory": true, "pegasus": true, "esde": true, "kino": true}
...
func normalizeSourceAdapter(in NewSourceAdapter) (NewSourceAdapter, error) {
	...
	if !sourceAdapterHandlers[in.Handler] {
		return in, errors.New("handler must be rom_directory, pegasus, esde, or kino")
	}
