// Package hashpack implements Kino's privacy-minimized ROM identity
...
// IdentityDomainV1 is the immutable wire-format domain for existing v1 packs.
// It is independent of the application name; changing it invalidates pack IDs.
const IdentityDomainV1 = "varkiv-hashpack-v1"

func packIdentity(source Source, release, recordsSHA256 string) string {
	parts := []string{IdentityDomainV1, source.ID, source.Name, source.Publisher, source.License, release, recordsSHA256}
